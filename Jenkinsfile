pipeline {
    ...
    stages {
        ...
        stage('Code Analysis') {
            steps {
                bat "dotnet sonarscanner begin /k:DeployBack /d:sonar.login=f4f2f069bc50fc86e24ecdc8343f0fd7b0239da4 /d:sonar.exclusions=**src/**domain/test/**/*.* /d:sonar.cs.opencover.reportsPaths=${COVERAGE_PATH}coverage.cobertura.xml"
