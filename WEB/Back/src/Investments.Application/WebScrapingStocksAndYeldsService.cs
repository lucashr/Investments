...
{
    public class WebScrapingStocksAndYeldsService
    {
        ...
        public WebScrapingStocksAndYeldsService(IDetailedStocksPersist detailedStocksPersist,
        ...
        public async Task<IEnumerable<StocksDividends>> GetYeldsStocksAsync(IEnumerable<DetailedStocks> detailedStocks, CancellationTokenSource cancellationTokenSource)
        {

            _cancellationTokenSource = cancellationTokenSource;
            // detailedStocks = await _stocksYeldPersist.GetAllStockDividendsAsync();
            var result = await DriverGetDividendsStocksAsync(detailedStocks);
        ...
        public async Task<IEnumerable<StocksDividends>> DriverGetDividendsStocksAsync(IEnumerable<DetailedStocks> detailedStocks)
        {
        ...
        private async Task<IEnumerable<DetailedStocks>> DriverGetStocksAsync()
        {
            ...
            try
            {
                ...
                var stockList = await ScrapeStockData();
        ...
        public async Task<IEnumerable<DetailedStocks>> ScrapeStockData()
        {
